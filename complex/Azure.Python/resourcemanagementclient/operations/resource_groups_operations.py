...
class ResourceGroupsOperations(object):
    ...
    def list_resources(
        ...
        :rtype: :class:`GenericResourcePaged
         <Azure.models.GenericResourcePaged>`
    ...
    def create_or_update(
        ...
        :param parameters: Parameters supplied to the create or update a
         resource group.
        :type parameters: :class:`ResourceGroup <Azure.models.ResourceGroup>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ResourceGroup <Azure.models.ResourceGroup>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def export_template(
        ...
        :type parameters: :class:`ExportTemplateRequest
         <Azure.models.ExportTemplateRequest>`
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :rtype: :class:`ResourceGroupExportResult
         <Azure.models.ResourceGroupExportResult>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def list(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`ResourceGroupPaged <Azure.models.ResourceGroupPaged>`
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def internal_paging(next_link=None, raw=False):
