...
class ResourcesOperations(object):
    ...
    def move_resources(
            self, source_resource_group_name, parameters, custom_headers=None, raw=False, **operation_config):
        ...
        :type parameters: :class:`ResourcesMoveInfo
         <Azure.models.ResourcesMoveInfo>`
    ...
    def get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :rtype: :class:`GenericResource <Azure.models.GenericResource>`
        :rtype: :class:`ClientRawResponse<msrest.pipeline.ClientRawResponse>`
         if raw=true
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
